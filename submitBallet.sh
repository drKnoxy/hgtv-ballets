...
url1="https://submit.engagesciences.com/display/form/post?"\
"email=$encoded_email"\
"&apikey=a587a142-38bd-4a4b-ad68-939d090ab1d1"\
"&campaignObjectId=38967"\
"&ngx_remember_me=true"\
"&ngx_check_entry=true"\
"&isXHR=true"
...
echo $bar #---------------------------------
echo "diynetwork.com part1"

url2="https://submit.engagesciences.com/display/form/post?"\
"email=$encoded_email"\
"&apikey=a587a142-38bd-4a4b-ad68-939d090ab1d1"\
"&campaignObjectId=39333"\
"&ngx_remember_me=true"\
"&ngx_check_entry=true"\
"&isXHR=true"
...
echo $bar #---------------------------------
echo "diynetwork.com part2"

# create a tmp form file with this email address
sed "s/\${email}/$email/" <hgtv_form-data.txt >tmp2.txt
